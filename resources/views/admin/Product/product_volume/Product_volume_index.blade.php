...
@section('header')
     <div class="row">
        <div class="col-lg-12">
         <h3><i class="fa fa-list"></i> Product Volume</h3>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Product Volume Listing</h5>

                                <div class="row"  align="right" style="margin-bottom: 10px;">
                                      <a href="{{ action('Admin\Product\Product_volume_Controller@getCreate') }}"><span class="btn btn-primary btn-xs"> <i class="fa fa-plus"></i> New Volume </span></a>
                                     ...
                                     <table class="table table-striped table-hover" id="PrintingeffectTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="no-sort hidden-sm-down">Volume</th>
                                                <th class="no-sort hidden-sm-down">Measurement</th>
...
$(function() {
            ...
            serverSide: true,
                ajax: {
                url : '{!! action('Admin\Product\Product_volume_Controller@getData') !!}',
                type:'GET',
            }, 
            aoColumns: [
                { data: 'product_volume_id', name: 'product_volume_id',orderable: false, searchable: false },

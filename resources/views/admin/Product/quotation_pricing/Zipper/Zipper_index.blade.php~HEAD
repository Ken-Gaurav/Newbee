        ...
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    ...
                    <a ><span class="nav-label">Zipper List</span></a>
                </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h2>Zipper Listing</h2>

                                <div class="row"  align="right" style="margin-bottom: 10px;">
                               
                                      <a href="{{ action('Admin\Product\Zipper_Controller@getCreate') }}"><span class="btn btn-primary btn-xs"> <i class="fa fa-plus"></i> Create Zipper</span></a>
                            ...
                            <div class="ibox-content">
                                <div class="table-responsive">
                                    ...
                                    <form id="frmFilter">
                                     ...
                                     <table class="table table-striped table-hover" id="zipper">
                                        <thead>
                                            <tr>
                                                <th><input type="checkbox" class="emp_checkbox" data-emp-id=""  id="chk" value=""></th>
                                                <th class="no-sort hidden-sm-down">Zipper Name</th>
...
$(function() {
            $dataTable = $('#zipper').DataTable({
            processing: true,
            serverSide: true,
                ajax: {
                url : '{!! action('Admin\Product\Zipper_Controller@getData') !!}',
                type:'GET',
            }, 
            aoColumns: [
                { data: 'zipper_id', name: 'zipper_id' , orderable: false, searchable: false},

...
@section('header')
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-list"></i>Industry</h3>
            <ol class="breadcrumb">
                <li>
                ...
                <li>
                    ...
                    <a ><span class="nav-label">Industry List</span></a>
                </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Industry Listing</h5>

                                <div class="row"  align="right" style="margin-bottom: 10px;">
                                      <a href="{{ action('Admin\CRM\Enquiry_Industry_Controller@getCreate') }}"><span class="btn btn-primary btn-xs"><i class="fa fa-plus"></i>{{ trans('dashboard.add') }}</span></a>
                            ...
                            <div class="ibox-content">
                                <div class="table-responsive">
                                    ...
                                    <form id="frmFilter">
                                     ...
                                     <table class="table table-striped table-hover" id="enquiry_industry">
                                        <thead>
                                            <tr>
                                                <th><input type="checkbox" id="select_all"></th>
                                                <th class="no-sort hidden-sm-down">Industry Name</th>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data['success']) {
                            ...
                            $('#enquiry_industry').DataTable().draw();                            
...
$(function() {
            $dataTable = $('#enquiry_industry').DataTable({
            processing: true,
            serverSide: true,
                ajax: {
                url : '{!! action('Admin\CRM\Enquiry_Industry_Controller@getData') !!}',
                type:'GET',
            }, 
            aoColumns: [
                { data: 'enquiry_industry_id', name: 'enquiry_industry_id',orderable: false, searchable: false },

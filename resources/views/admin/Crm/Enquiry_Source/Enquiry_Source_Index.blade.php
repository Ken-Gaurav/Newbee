...
@section('header')
    <div class="row">
        <div class="col-lg-12">
            <h3><i class="fa fa-list"></i> Enquiry Source</h3>
            <ol class="breadcrumb">
                <li>
                ...
                <li>
                    ...
                    <a ><span class="nav-label">Enquiry Source List</span></a>
                </li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Enquiry Source Listing</h5>

                                <div class="row"  align="right" style="margin-bottom: 10px;">
                                      <a href="{{ action('Admin\CRM\Enquiry_Source_Controller@getCreate') }}"><span class="btn btn-primary btn-xs"><i class="fa fa-plus"></i>{{ trans('dashboard.add') }}</span></a>
                            ...
                            <div class="ibox-content">
                                <div class="table-responsive">
                                    ...
                                    <form id="frmFilter">
                                     ...
                                     <table class="table table-striped table-hover" id="enquiry_source">
                                        <thead>
                                            <tr>
                                                <th><input type="checkbox" id="select_all"></th>
                                                <th class="no-sort hidden-sm-down">Enquiry Source Name</th>
...
$(function() {
            $dataTable = $('#enquiry_source').DataTable({
            processing: true,
            serverSide: true,
                ajax: {
                url : '{!! action('Admin\CRM\Enquiry_Source_Controller@getData') !!}',
                type:'GET',
            }, 
            aoColumns: [
                { data: 'enquiry_source_id', name: 'enquiry_source_id',orderable: false, searchable: false },

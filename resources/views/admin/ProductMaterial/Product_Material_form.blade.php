                    ...
                    <form class="form-horizontal blog-form" role="form" method="POST" action="{{ action('Admin\Product\Product_MaterialController@postSave') }}" enctype="multipart/form-data">
                       ...
                       <div class="form-group{{ $errors->has('product_layer_id') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <button type="button"  value="+"  id="Addition" class="btn btn-circle btn-primary add_more_button" title="Add Profit"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                         <!-- <button id="btnAdd1" type="button" value="+" class="btn btn-circle btn-primary add_more_button"/><i class="fa fa-plus" aria-hidden="true"></i></button> -->
                                          ...
                                          <button type="button"  value="+"  id="btnAdd1" class="btn btn-circle btn-primary add_more_button" title="Add Profit"><i class="fa fa-plus" aria-hidden="true"></i></button>
...
function GetDynamicTextBox(value) {
 ...
 var count = $(".div_c").length+1;
    ...
    return '<div class="col-lg-12">'+'<div class="row">'
        +'<div class="col-lg-2" id="thickness_'+count+'">'
        +'{{Form::hidden("thickness_form[]",old("thickness_form[]", isset($product_material) ? $product_material->thickness_form : ''),["class" => "form-control","required"=>"required","id"=>"form_1"])}}'
        +'</div>' 
        +'<div class="col-lg-2" id="thickness_'+count+'">'+'{{Form::text("thickness_to[]",old("thickness_to[]", isset($product_material) ? $product_material->thickness_to : ''),["class" => "form-control","required"=>"required","id"=>"to_1"])}}'
        +'</div>'
        +'<div class="col-lg-2" id="thickness_'+count+'">'+'{{Form::text("thickness_price[]",old("thickness_price[]", isset($product_material) ? $product_material->thickness_price : ''),["class"=>"form-control","required"=>"required","id"=>"price_1"])}}'
        +'</div>'

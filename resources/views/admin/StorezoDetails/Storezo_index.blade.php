                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <div class="row"  align="right" style="margin-bottom: 10px;">
                                      <a href="{{ action('Admin\Product\StorezoDetailController@getCreate') }}"><span class="btn btn-primary btn-xs"><i class="fa fa-plus"></i> Add Accessorie</span></a>
...
$(function() {
            ...
            $(document).on('change','input.js-switch', function() {
                ...
                if (confirm("Are you sure Status changed!")) {
                    $.ajax({
                        "url": '{!! action("Admin\Product\StorezoDetailController@anyData1") !!}',
                        async: false,

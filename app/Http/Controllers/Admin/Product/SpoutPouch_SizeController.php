...
class SpoutPouch_SizeController extends Controller
{
   ...
   public function getRemove(Request $request)
  {
	...
	{
		$product_name=Product_model::select(['product_name','product_id'] )
		...
		$spout_pouch = Product_model::leftjoin('spout_pouch_size_master','product.product_id','=','spout_pouch_size_master.product_id')->where('spout_pouch_size_master.product_id','=',$spout_pouch)->select(['spout_pouch_size_master.*','product.product_name','product.product_id'])->get();

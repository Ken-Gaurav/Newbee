...
class product_controller extends Controller
{
   ...
   public function getIndex()
    ...
    public function getCreate()
	{
     ...
     return view('admin.product.form',compact('product_make','product_qty'));
 ...
 //$product_qty = Product_Quantity::select('quantity')->get();
        ...
        return view('admin.product.form', compact('Product_model','product','product_make','product_qty',''))->with('success');
    }

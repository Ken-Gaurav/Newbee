...
class Country_Controller extends Controller
{
    ...
    public function getData() {
        ...
        ->addColumn('country_id', function ($country) {
            ...
            ->addColumn('action', function ($country) use($menu_id,$EditPermission,$DeletePermission) {
             
                return ((in_array($menu_id,$EditPermission)) ? '<a href="'. action('Admin\Setting\Country_Controller@getEdit', [$country->country_id]) .'" class="btn btn-xs btn-primary"><i class="fa fa-pencil-square-o"></i> Edit</a>&nbsp;' : '').    
               ((in_array($menu_id,$DeletePermission)) ? '<a  href="'. action('Admin\Setting\Country_Controller@getDelete', [$country->country_id]) .'" data-id="'. $country->country_id . '" class="btn btn-xs btn-danger btn-delete"><i class="fa fa-trash"></i> Delete</a>' : '');
